select q2.id, q2.name, q2.gift_request_id, q2.acceptance_seen, q2.delivery_request_seen, r.user_id, avg(stars) from ratings r 
left join (select  d.id, d.user_id, u.name, d.gift_request_id, d.acceptance_seen, d.delivery_request_seen 
...
group by r.user_id, q2.id, q2.name, q2.gift_request_id, q2.acceptance_seen, q2.delivery_request_seen;
