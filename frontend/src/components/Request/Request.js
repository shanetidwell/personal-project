            ...
            <div style={styles.page}>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <span>Street</span>
                        <input type="text" value={this.state.street} name = "street" onChange={this.handleChange}></input>
                        <span>City</span>
...
export default connect(mapStateToProps,{addGiftRequest, addAddress})(Request);